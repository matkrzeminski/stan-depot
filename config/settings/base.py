...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default=f"sqlite:///{str(ROOT_DIR / 'stan_depot.db')}",
    ),
}
...
# TODO: add user model and login urls
...
EMAIL_HOST_USER = env("EMAIL_HOST_USER", default="admin@stan-depot.com")
